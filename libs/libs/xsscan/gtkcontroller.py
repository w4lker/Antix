...
from xsscan.globalmap import GlobalMap
from xsscan.reporter import xsscanReporter
from xsscan.mozchecker import MozChecker

class Controller(xsscanReporter):
